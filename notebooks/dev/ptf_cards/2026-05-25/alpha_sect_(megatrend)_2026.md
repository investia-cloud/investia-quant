...
|-----------|------------|------|--------|-------|
| Cluster — Risk ON/OFF | 143.8% | 12.0% | 0.58 | 26.8% |
| Cluster — Base | 257.0% | 17.6% | 0.67 | 35.7% |
| Standard — Risk ON/OFF | 159.1% | 13.1% | 0.74 | 23.2% |
| Standard — Base | 325.8% | 20.5% | 0.84 | 32.5% |
| Benchmark (Indice sintetico settoriali) | 259.6% | 17.9% | 0.75 | 67.2% |
...
| S4 — DSR | Lo Sharpe è significativo dopo correzione per n. trial? | Pass | 0.6572900278740242 |
...
| S3 — Random selection | Il risultato Out-Of-Sample batte 1000 portafogli con parametri casuali? | Fail | p=0.69 |
| S4 — DSR | Lo Sharpe è significativo dopo correzione per n. trial? | Pass | 0.5277861903500409 |
| **OFC Verdict** | Soglia: 3/4 segnali | **PROMOTED** | |
...
| Test | Cosa misura | Verdetto | p-value |
|------|-------------|---------|----------|
| B1 — Rotation Reshuffle | La rotazione batte una selezione casuale dei titoli? | Pass | p=0.014 |
| B2 — Rebalance Timing | Il timing mensile batte date di ribilanciamento casuali? | Fail | p=0.728 |

### 5b. Confidence Intervals (Block A) — Path Standard
| Metodo | CAGR p5 | CAGR p50 | CAGR p95 | Sharpe p50 | MaxDD p50 |
|--------|---------|---------|---------|-----------|----------|
| A1 — IID Bootstrap | 0.003 | 0.086 | 0.179 | 0.601 | -0.299 |
| A2 — Block Bootstrap | 0.026 | 0.089 | 0.149 | 0.622 | -0.230 |

### 5b. Confidence Intervals (Block A) — Path Cluster
| Metodo | CAGR p5 | CAGR p50 | CAGR p95 | Sharpe p50 | MaxDD p50 |
|--------|---------|---------|---------|-----------|----------|
| A1 — IID Bootstrap | -0.026 | 0.082 | 0.200 | 0.481 | -0.409 |
| A2 — Block Bootstrap | 0.009 | 0.079 | 0.156 | 0.469 | -0.289 |
...
| CAGR vs Benchmark | 13.1% vs 17.9% | 12.0% vs 17.9% |
| Sharpe vs Benchmark | 0.74 vs 0.75 | 0.58 vs 0.75 |
