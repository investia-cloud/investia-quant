...
|-----------|------------|------|--------|-------|
| Cluster — Risk ON/OFF | 257.5% | 17.4% | 0.81 | 26.4% |
| Cluster — Base | 319.5% | 19.8% | 0.84 | 34.9% |
| Standard — Risk ON/OFF | 51.2% | 5.4% | 0.36 | 43.0% |
| Standard — Base | 91.3% | 8.7% | 0.48 | 43.0% |
| Benchmark (^STOXX50E) | 58.4% | 6.1% | 0.37 | 38.3% |
...
| S4 — DSR | Lo Sharpe è significativo dopo correzione per n. trial? | Pass | 0.3169878049221985 |
...
| S3 — Random selection | Il risultato Out-Of-Sample batte 1000 portafogli con parametri casuali? | Fail | p=0.123 |
| S4 — DSR | Lo Sharpe è significativo dopo correzione per n. trial? | Pass | 0.7841202088527061 |
...
|--------|---------|---------|---------|-----------|----------|
| A1 — IID Bootstrap | -0.048 | 0.037 | 0.129 | 0.297 | -0.409 |
| A2 — Block Bootstrap | -0.051 | 0.034 | 0.128 | 0.278 | -0.440 |
...
| CAGR vs Benchmark | 5.4% vs 6.1% | 17.4% vs 6.1% |
